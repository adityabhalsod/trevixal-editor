...
[![license](https://img.shields.io/npm/l/@trevixal/web-component.svg)](https://github.com/adityabhalsod/trevixal-editor/blob/main/LICENSE)

[Documentation](https://trevixal-editor.vercel.app) · [Live editor](https://trevixal-editor.vercel.app/full-editor) · [Changelog](https://github.com/adityabhalsod/trevixal-editor/blob/main/packages/web-component/CHANGELOG.md) · [Issues](https://github.com/adityabhalsod/trevixal-editor/issues)
...
`editor` is the full engine, so anything in `@trevixal/core` is reachable from
a page with no build step at all.
...
time, so the class extends a stand-in when there is no DOM. The module
imports cleanly on a server; the element registers only where a real DOM
exists.
